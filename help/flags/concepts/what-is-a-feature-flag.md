...
>[!NOTE]
>
>In Flags, a feature flag is the most atomic unit of feature control. It can be used on its own to target a single feature, or combined with other flags in a [feature group](feature-groups-to-control-multiple-features.md).
