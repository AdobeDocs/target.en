...
Flags provides two artifacts for managing feature rollouts. Choosing the right one depends on the scope of your rollout and the number of features involved.
