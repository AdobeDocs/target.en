...
The Mobile VEC supports setting up of click tracking goals for the Target Activities.
...
* In VEC, only those elements that have a click handler attached are allowed to be selected.
