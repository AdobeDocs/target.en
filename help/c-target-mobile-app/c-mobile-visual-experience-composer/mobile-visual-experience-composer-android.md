...
> [!NOTE]
>
> If the targetView function is not triggered, the VEC extension tries to identify View from the Android Activity. For appliications that do not have dynamic views, this can be an optional step.
