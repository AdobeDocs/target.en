...
||[Activities](/help/main/c-activities/activities.md)|Updated article to reflect the [!UICONTROL Activity] page UI refresh.|
||[Feeds](/help/main/c-recommendations/c-products/feeds.md)|Updated article to reflect the [!UICONTROL Feeds] page UI refresh.|
