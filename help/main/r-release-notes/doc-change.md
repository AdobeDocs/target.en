...
|Date|Topic|Changes|
|--- |--- |--- |
|November 20|[Create a Recommendations activity](/help/main/c-recommendations/t-create-recs-activity/create-recs-activity.md)|Added following note under Step 5: <ul><li>[!UICONTROL Recommendations] activities support only one modification/recommendation at a time. For multiple recommendations, you can either create several [!DNL Recommendations] activities or use A/B or XT testing.</li></ul>|
|November 14|[[!DNL Target] release notes (current)](/help/main/r-release-notes/release-notes.md)|Added release notes for the [!DNL Target Standard/Premium] 25.11.2 release.|
...
|Date|Topic|Changes|
|--- |--- |--- |
|October 9|[Manage exclusions](/help/main/c-activities/t-automated-personalization/managing-exclusions.md)|Updated steps.|
||[Visual Editing Helper extension](/help/main/c-experiences/c-visual-experience-composer/r-troubleshoot-composer/visual-editing-helper-extension.md)|Updated link to obtain the extension.|
||[[!DNL Target] UI update FAQs](/help/main/c-intro/updated-ui-faq.md)|Relocated deprecation information from the Release notes page.|
...
|Date|Topic|Changes|
|--- |--- |--- |
|September 1|[[!DNL Target] release notes (current)](/help/main/r-release-notes/release-notes.md)|Added release notes for the [!DNL Target Standard/Premium] 25.8.4 release.|
...
|Date|Topic|Changes|
|--- |--- |--- |
|June 2|[[!UICONTROL Visual Experience Composer] best practices and limitations](/help/main/c-experiences/c-visual-experience-composer/experience-composer-best-practices.md#ext)|Added the following limitation: "Handling VEC compatibility with Chrome extension policy changes."|
...
|May 13|[[!DNL Target] release notes (prerelease)](/help/main/r-release-notes/target-release-notes.md)|Added prerelease notes for the [!DNL Adobe Target] [!DNL AI Assistant] feature.|
|May 8|[[!DNL Target] release notes (current)](/help/main/r-release-notes/release-notes.md)|Added release notes for the [!DNL Target Standard/Premium] 25.5.2 release.|
|May 5|[[!DNL Target] release notes (current)](/help/main/r-release-notes/release-notes.md)|Added release notes for the [!DNL Target Standard/Premium] 25.5.1 release.|
