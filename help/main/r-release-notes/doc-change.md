...
||[Considerations and known limitations](https://experienceleague.adobe.com/en/docs/target-dev/developer/api/delivery-api/known-limitations){target=_blank} in the *[!DNL Target] Developer Guide*|Added information about using caution when updating [!DNL Recommendations] [!UICONTROL Catalogs] via the [!DNL Target Delivery API].|
