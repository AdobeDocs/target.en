...
1. Ensure that you are using Platform Web SDK version 2.6.0 (or later) or at.js version 1.1 (or later).
   ...
   * **at.js**: See [Download at.js](https://experienceleague.corp.adobe.com/docs/target-dev/developer/client-side/at-js-implementation/deploy-at-js/implement-target-without-a-tag-manager.html){target=_blank}. 
...
Use [at.js custom events](https://experienceleague.corp.adobe.com/docs/target-dev/developer/client-side/at-js-implementation/functions-overview/atjs-custom-events.html){target=_blank} to listen for the [!DNL Target] response and read the response tokens.
