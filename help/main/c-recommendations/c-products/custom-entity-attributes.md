...
See the [Adobe Recommendations API documentation](https://experienceleague.adobe.com/docs/target-dev/developer/recommendations.html){target=_blank} for information about using the Delivery and Save entities APIs.
