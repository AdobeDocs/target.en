...
See [Delivery API documentation](https://experienceleague.corp.adobe.com/docs/target-dev/developer/implementation/delivery-api/overview.html){target=_blank} for more information.
