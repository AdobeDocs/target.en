...
## Adding Filtering Rules to Criteria and Promotions {#section_CD0D74B8D3BE4A75A78C36CF24A8C57F}

* **Criteria**: While you are [creating criteria](/help/main/c-recommendations/c-algorithms/create-new-algorithm.md#task_8A9CB465F28D44899F69F38AD27352FE), click **[!UICONTROL Add Filtering Rule]** under **[!UICONTROL Inclusion Rules]**.

  The available options vary depending on the selected industry vertical and recommendation key.

* **Promotions**: While [creating a promotion](/help/main/c-recommendations/t-create-recs-activity/adding-promotions.md#task_CC5BD28C364742218C1ACAF0D45E0E14), select **[!UICONTROL Promote by Attribute]**, then click **[!UICONTROL Add Filtering Rule]**.
...
| --- | --- |
|[Static Filter](/help/main/c-recommendations/c-algorithms/static-value.md)|Manually enter one or more static values to filter.|
