...
* **[!DNL Adobe Journey Optimizer] sends a bulk email after site visits to remind visitors which items were viewed**: This use case is based visitors visiting a website, viewing various items, and then leaving the site or app without placing items in the shopping cart.
