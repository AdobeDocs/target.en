...
For more information, see the [Adobe Target Security Overview](https://experienceleague.adobe.com/en/docs/target-dev/developer/implementation/target-security-overview).
