...
Following best practices can help make your experiences work as expected. There are also other tips and limitations that you should be aware of when using the [!UICONTROL Visual Experience Composer] (VEC) in [!DNL Adobe Target].
...
See [Element Selectors Used in the Visual Experience Composer](/help/main/c-experiences/c-visual-experience-composer/vec-selectors.md#concept_4EB7663E255F439B8D24079D23479337) .
...
### The customCode action in the VEC does not work with Internet Explorer 8.
