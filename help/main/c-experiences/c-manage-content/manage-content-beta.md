...
|[!UICONTROL Last updated]|Displays the date and time the offer was last modified and by whom.<P>Click the table header to sort the list ascending or descending order by date.|
