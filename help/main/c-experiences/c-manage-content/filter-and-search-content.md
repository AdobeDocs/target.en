...
1. Click the **[!UICONTROL Content Only]** icon in the top left corner to display the search box.
   ...
   ![Content Only option](/help/main/c-experiences/c-manage-content/assets/content-only.png)
...
1. (Optional) use the **[!UICONTROL Filters and Options]** pane to further refine your search.
   ...
   ![Filter and Options pane](/help/main/c-experiences/c-manage-content/assets/filter-and-options.png)
