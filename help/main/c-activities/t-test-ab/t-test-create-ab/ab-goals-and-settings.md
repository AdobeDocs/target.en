...
|[!UICONTROL Statistical Methodology]|Choose the statistical methodology used to analyze and report on this activity's [!UICONTROL Conversion] goal metric:<ul><li>**[!UICONTROL Welch's t-test]** (default): the existing frequentist methodology. Reports show a [!UICONTROL Confidence] percentage and confidence interval.</li><li>**[!UICONTROL Bayesian]**: reports show [!UICONTROL Chance to Beat Control] and a credible interval instead of the frequentist [!UICONTROL Confidence] column. Selecting [!UICONTROL Bayesian] applies default settings of a 95% credible interval, a neutral prior, and a 95% [!UICONTROL Chance to Beat Control] threshold. Expand **[!UICONTROL Adjust]** to change the credible interval level, the decision threshold, or to provide prior knowledge from past performance.</li></ul>This setting is only available for activities whose primary goal metric is [!UICONTROL Conversion], activities with a [!UICONTROL Revenue] or [!UICONTROL Engagement] primary goal always use [!UICONTROL Welch's t-test]. For more information about how each methodology is calculated and reported, see [Statistical calculations in A/Bn tests](/help/main/c-reports/statistical-methodology/statistical-calculations.md).|
