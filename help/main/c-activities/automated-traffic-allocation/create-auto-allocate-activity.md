...
description: Learn how to use the [!UICONTROL Visual Experience Composer] (VEC) in [!DNL Adobe Target] to create an [!UICONTROL Auto-Allocate] A/B Test activity.
...
1. In the **[!UICONTROL Create A/B Test Activity]** dialog box, select **[!UICONTROL Visual]**, if necessary.
...
1. Specify your [activity URL](/help/main/c-activities/t-test-ab/t-test-create-ab/ab-activity-url.md), then click **[!UICONTROL Create]**.
